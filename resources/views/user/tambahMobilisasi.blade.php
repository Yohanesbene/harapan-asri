...
<x-guest-layout>
    <x-auth-card>
        ...
        <form method="POST" action="{{ route('user.storeMobilisasi') }}">
            @csrf
            ...
            <!-- Hasil Input -->
            <x-label class="mt-4" for="hasil" :value="__('Keterangan')" />
            <x-input id="hasil" type="text" name="hasil" :value="old('hasil')" placeholder="Hasil" autocomplete="off"/>
