...
<x-guest-layout>
    <x-auth-card>
        ...
        <form method="POST" action="{{ route('user.storeNutrisi') }}">
            @csrf
            ...
            <!-- keterangan Input -->
            <x-label class="mt-4" for="keterangan" :value="__('Keterangan (dalam Porsi)')" />
            <x-input id="keterangan" type="number" name="keterangan" :value="old('keterangan')" placeholder="keterangan" autocomplete="off" step="0.01"/>
